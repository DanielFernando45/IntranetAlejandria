        ...
        <div className='flex flex-col absolute gap-[15px] top-60 left-96 px-10 pt-12 w-[875px]  rounded-lg bg-white border border-[#D2CECF]'>
                    ...
                    <div className="flex gap-3 items-center">
                        <div className="flex w-full h-8 rounded-md px-[10px] py-[6px] justify-between bg-[#E4E2E2]">
                            <input
                                ...
                                type="text"
                                placeholder="Buscar por IdAsesoria, DNI o nombre..."
                            />
            ...
            <div className='flex flex-col'>
                <div className='flex justify-between text-[#495D72] p-2'>
                    <div className='w-[120px]'>IdAsesoria</div>
                    <div className='w-[380px]'>Delegado/Cliente</div>
                    <div className='w-[150px]'>DNI</div>
                    <div className='w-[150px]'>Tipo trabajo</div>
                    <div className='w-[80px]'></div>
                </div>
                <div className='flex justify-between p-2'>
                    <div className='w-[120px]'>0237</div>
                    <div className='w-[380px]'>Antonio Jorge Cueva López</div>
                    <div className=' w-[150px] '>78451236</div>
                    <div className='w-[150px]'>Tesis maestria</div>
                    <button className='w-[80px] bg-slate-500 rounded-lg text-white'>
                        <input className='w-full  rounded-full' type="checkbox" />
                    </button>
                </div>
            ...
            <div className='flex justify-between'>
                <div className='flex flex-col w-full h-[82px] gap-[15px]'>
                    ...
                    <input placeholder='Digite el Servicio extra' className='flex items-center rounded-2xl text-[#1C1C34] w-full h-[43px] bg-[#E9E7E7] px-4 font-medium' />
                </div>
            ...
            <div className='flex w-full py-4 px-1 h-[68px] justify-end gap-4'>
                <button onClick={close} className='h-7  w-[100px] border   rounded-[4px] text-[11px] font-bold '>Cancelar</button>
                <button className='h-7  w-[100px] border bg-black rounded-[4px] text-[11px] font-bold text-white'>Agregar</button>
