...
const DocPendientes = () => {
  ...
  const toggleOpen = (id) => {
    setOpenItems(prev => ({
      ...prev,
      [id]: !prev[id] // Solo cambia el estado del item clickeado
    }))
  }

  const toggleFechaEstimada = (id) => {
    setFechaEstimada(prev => ({
      ...prev,
      [id]: !prev[id]
    }))
  }
              ...
              <div className='flex flex-col transition-all duration-300 ease-in-out mt-5'>
                <div className='flex justify-between'>
                  ...
                  <div className='flex gap-5'>
                    ...
                    <input 
                      onClick={() => toggleFechaEstimada(pendiente.id_asunto)} 
                      className='w-[25px]' 
                      type="checkbox" 
                    />
                  </div>
