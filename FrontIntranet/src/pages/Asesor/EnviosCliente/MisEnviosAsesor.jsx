          ...
          return (
            <React.Fragment key={envio.id_asunto || index}>
              ...
              {openItems[index] && hasDocuments && (
                <div className="bg-white shadow-md  rounded-md  px-[6px] ">
                  <div className="flex justify-between items-center py-2 border-b last:border-b-0">
                    <div className="w-[300px] flex">{envio.asunto}</div>
                    <div className="w-[98px] flex justify-center">{envio.estado}</div>
                    <div className="w-[100px] flex justify-center">{formatDate(envio.fecha)}</div>
                    <div className="w-[368px] flex flex-col gap-1 justify-center  font-semibold text-[#495D72]">
                      {documents.map((doc, docIndex) => (
                        ...
                        >
                          ...
                          <div className="w-[250px] flex justify-start overflow-hidden text-ellipsis whitespace-nowrap max-w-[25ch]">
