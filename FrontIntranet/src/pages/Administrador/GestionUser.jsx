                          ...
                          {vista === "Clientes" ?(
                            ...
                            <div className="flex flex-col  ">
                                   ...
                                   <div className="flex justify-between items-center text-[#2B2829] font-normal p-[6px] rounded-md">
                                                      ...
                                                      <div className="w-[360px] flex justify-start">Administracion de empresas Internacionales</div>
                                                      <div className="w-[250px] flex justify-start">Plazo/Al contado/Grupal</div>
                                   ...
                                   <div className="flex justify-between items-center text-[#2B2829] font-normal bg-[#E9E7E7]  p-[6px] rounded-md">
                                                      <div className="w-[40px] flex justify-center">0125</div>
                                                      <div className="w-[300px] flex justify-start">Juan Mateo Pérez Vinlof</div>
                                                      <div className="w-[100px] flex justify-center">Por asignar</div>
                                                      <div className="w-[102px] flex justify-center">Por asignar</div>
                                                      <div className="w-[360px] flex justify-start">Administracion de empresas </div>
                                                      <div className="w-[250px] flex justify-start">Plazo/Al contado/Grupal</div>
                                                      <div className="w-[110px] rounded-md px-3 py-1 bg-[#1C1C34]  flex justify-center text-white"> Editar </div>
                                                      <div className="w-[110px] rounded-md px-3 py-1 bg-[#8F1313]  flex justify-center text-white"> Eliminar </div>
                                   </div> 
                                   <div className="flex justify-between items-center text-[#2B2829] font-normal   p-[6px] rounded-md">
                                                      ...
                                                      <div className="w-[360px] flex justify-start">Administracion de empresas Internacionales</div>
                                                      <div className="w-[250px] flex justify-start">Avance/Al contado/Individual</div>
                                                      <div className="w-[110px] rounded-md px-3 py-1 bg-[#1C1C34]  flex justify-center text-white"> Editar </div>
                                                      <div className="w-[110px] rounded-md px-3 py-1 bg-[#8F1313]  flex justify-center text-white"> Eliminar </div>
                                   </div> 
                                   <div className="flex justify-between items-center text-[#2B2829] font-normal bg-[#E9E7E7]  p-[6px] rounded-md">
