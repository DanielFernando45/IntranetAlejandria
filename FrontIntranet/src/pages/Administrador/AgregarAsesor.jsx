            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex gap-10'>
                 ...
                 <div className='flex flex-col gap-3 w-full'>
                    ...
                    <div className='flex flex-col gap-3 w-full'>
                        ...
                        <input placeholder='Ingrese Especialidad' className='flex bg-[#F9F9F9] w-full h-[49px] rounded-lg text-[#808080] items-center p-4' />
                    </div>
                ...
                <div className='flex  gap-10 '>
                     ...
                     <div className='flex flex-col gap-3 w-full'>
                                   <p className='pl-[1px]'>Teléfono</p>
                                    <input placeholder='Ingrese telefono' className='flex bg-[#F9F9F9] w-full h-[49px] rounded-lg text-[#808080] items-center p-4'  />
                     </div>
                ...
                <div className='flex gap-10 items-end'>
                     ...
                     <div className='flex flex-col gap-3 w-full'>
                                    ...
                                    <input placeholder='Ingresa DNI' className='flex bg-[#F9F9F9] w-full h-[49px] rounded-lg text-[#808080] items-center p-4'/> 
                     </div>
