...
const Induccion = () => {
  ...
  return (
    ...
    <LayoutApp>
            ...
            <div className="flex flex-col gap-[10px] pt-3  px-[30px] py-[10px] w-full  bg-white border-b border-slate-300 rounded-t-lg shadow-lg">
              <div className="flex flex-col">
                <div className="flex justify-between text-[#495D72] font-medium p-[6px] rounded-md">
                  ...
                  <div className="flex-1 flex justify-center max-w-[150px]">Área</div>
      ...
      <ModalSubirInduccion openModal={openModal} setOpenModal={setOpenModal} idSeleccionado={idSeleccionado} setIdSeleccionado={setIdSeleccionado} />
