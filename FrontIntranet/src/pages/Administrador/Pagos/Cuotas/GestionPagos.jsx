    ...
    return (
        ...
        <div className="flex flex-col ">
            ...
            <div className="flex justify-between items-center text-[#2B2829] font-normal   p-[6px] pr-10 rounded-md">
                ...
                <button onClick={() => setActualizar(true)} className="w-[160px] font-medium rounded-md px-4 py-1 bg-[#1C1C34] ml-5 flex justify-center text-white text-[14px]"> Actualizar Pagos </button>
                <button onClick={() => setEditar(true)} className="w-[120px] font-medium rounded-md px-4 py-1 bg-[#0A8EAA] ml-1 flex justify-center text-white text-[14px]"> Editar </button>
            </div>
        ...
        {actualizar && <ActualizarPago onClose={() => setActualizar(false)}/>}

        {editar && <EditarCuotaEdit Close={() => setEditar(false)} />}
        </>
