    ...
    return (
        <div className="flex flex-col bg-white rounded-b-lg ml-8 p-5">
            <div className='flex w-full justify-between items-center'>
                ...
                <button className='flex justify-between items-center bg-[#1C1C34] rounded-3xl px-2 text-white text-[16px] w-48 h-10 '>
                    Agregar servicio
            ...
            <div>
                <div className="flex justify-between text-[#495D72] font-medium p-[6px] pr-10 rounded-md">
                    ...
                    <div className="w-[160px] flex justify-center">Creacion</div>
