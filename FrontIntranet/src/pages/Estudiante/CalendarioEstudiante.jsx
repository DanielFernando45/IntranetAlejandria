...
const CalendarioEstudiante = () => {
  return (
    <LayoutApp>
       <main className='ml-36 mt-32 flex gap-[60px]'> 
        <div className='w-[600px]'>
            <div className='flex justify-between mb-10'>
               <p className='font-semibold text-[20px]'>Calendario de actividades</p>  
               <div className='flex gap-3'>
                <button className='bg-[#1C1C34] rounded-lg text-white w-[82px] h-[27px] font-semibold'>Marzo  </button>
                <button className='bg-[#1C1C34] rounded-lg text-white w-[82px] h-[27px] font-semibold'>2025  </button>
               </div>
            </div>
        ...
        <div className='flex flex-col w-full h-full justify-center p-5 gap-32'>
            <div>
